		...
		return {
			...
			apps: [
				...
				},
				{
					...
					{
					icon: "statics/destinations/travel-4.svg",
					name: "uber",
					add: "https://media.graytvinc.com/images/810*450/KFC30.jpg"
				},
				{
					icon: "statics/destinations/travel-5.svg",
					name: "yelp",
					add:
