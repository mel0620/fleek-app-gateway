...
export default {
	data() {
		...
		apps: [
			...
			{
				icon: "statics/music/music-4.svg",
				name: "tunein",
				add: "https://media.graytvinc.com/images/810*450/KFC30.jpg"
			},
			{
				icon: "statics/music/music-5.svg",
				name: "deezer",
				add:
